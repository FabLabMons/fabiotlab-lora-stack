...
module.exports = {
    ...
    // lost.
    credentialSecret: "FabI0T1ab_takes-security°seriously^as°you-can_see!",
    ...
    //httpNodeAuth: {user:"xxx",pass:"xxx"},
    //httpStaticAuth: {user:"xxx",pass:"xxx"},
    ...
    editorTheme: {
        ...
        header: {
            ...
            url: "http://" + process.env.MDNS_HOSTNAME + "/red"
        },
        login: {
